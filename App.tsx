      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <div className="flex items-center group cursor-pointer">
            <span className="text-2xl font-black tracking-tighter text-[#EA4643] flex items-center transition-transform group-hover:scale-105">
              QITPES <span className="text-slate-900 font-light ml-1">ERP</span>
            </span>
          </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="p-12 bg-white rounded-[4rem] border border-slate-100 shadow-3xl relative overflow-hidden group">
              ...
              <div className="absolute top-0 -inset-full h-full w-1/2 z-5 block transform -skew-x-12 bg-gradient-to-r from-transparent to-red-50/50 opacity-40 group-hover:animate-shine" />
            </div>
          </div>
        </div>
      </div>
...
const EcosystemHub = () => {
  ...
  const integrations = [
    ...
    { name: "SAP Bridge", icon: Server, color: "text-red-600" },
  ...
  return (
    <section id="integrations" ref={domRef} className="py-32 bg-slate-950 text-white overflow-hidden relative">
        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="relative">
             ...
             <div className="relative w-full aspect-square flex items-center justify-center">
                ...
                <div className="w-48 h-48 bg-[#EA4643] rounded-[3rem] shadow-[0_0_100px_rgba(234,70,67,0.5)] flex flex-col items-center justify-center relative z-10 animate-pulse">
      ...
      <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(circle_at_top_right,_rgba(234,70,67,0.1)_0%,_transparent_60%)]"></div>
    </section>
  );
};
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
              ...
              <div className="space-y-10">
                <div className="space-y-4">
                  <div className="flex justify-between font-black text-slate-900 uppercase tracking-widest text-xs">
                    ...
                    <span className="text-[#EA4643]">${projectValue}M</span>
                  </div>
                  <input 
                    type="range" 
                    min="1" 
                    ...
                    className="w-full h-3 bg-red-200 rounded-lg appearance-none cursor-pointer accent-[#EA4643]"
                  />
                </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white p-12 rounded-[4rem] border border-red-100 shadow-3xl text-center overflow-hidden">
                ...
                <a href={ERP_URL} className="inline-block bg-[#EA4643] text-white px-10 py-5 rounded-2xl font-black hover:bg-[#D13D3A] transition-all shadow-xl shadow-red-200">Get Detailed Report</a>
                <div className="absolute top-0 -inset-full h-full w-1/2 z-5 block transform -skew-x-12 bg-gradient-to-r from-transparent to-red-50/50 opacity-40 group-hover:animate-shine" />
              </div>
            </div>
          </div>
...
const GlobalCommandCenter = () => {
  ...
  return (
    <section ref={domRef} className="py-32 bg-slate-900 text-white overflow-hidden relative">
      ...
      <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-red-600/10 to-transparent"></div>
    </section>
  );
};
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {modules.map((m, idx) => (
            ...
            >
              ...
              <div className="w-16 h-16 bg-red-50 text-[#EA4643] rounded-2xl flex items-center justify-center mb-8 group-hover:bg-[#EA4643] group-hover:text-white transition-all duration-500 shadow-sm relative z-10">
                <m.icon size={32} />
              </div>
              <h3 className="text-2xl font-black text-slate-900 mb-4 tracking-tight leading-tight relative z-10 group-hover:text-[#EA4643] transition-colors">{m.name}</h3>
            ...
            <div className="grid sm:grid-cols-2 gap-x-12 gap-y-4">
              {industries.map((industry, idx) => (
                <div key={idx} className="flex items-center space-x-4 border-b border-slate-50 py-5 group cursor-default">
                  ...
                  <span className="text-lg font-black text-slate-800 group-hover:text-[#EA4643] transition-colors duration-300">{industry}</span>
                </div>
              ))}
            </div>
          </div>
...
const Implementation = () => {
  ...
  return (
    <section id="implementation" ref={domRef} className="py-40 bg-red-950 text-white overflow-hidden relative">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] bg-red-900/20 rounded-full blur-[180px] -z-0"></div>
    </section>
  );
};
        ...
        <div className={`bg-[#EA4643] rounded-[6rem] p-16 lg:p-40 text-center text-white relative overflow-hidden shadow-[0_60px_120px_-20px_rgba(234,70,67,0.4)] transition-all duration-1000 ${isVisible ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}>
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="absolute top-0 -inset-full h-full w-1/2 z-5 block transform -skew-x-12 bg-gradient-to-r from-transparent to-red-200/50 opacity-40 group-hover:animate-shine" />
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-4 gap-20 mb-32">
        ...
        <div>
          ...
          <ul className="space-y-6 text-slate-500 font-bold text-xl">
            <li><a href="#modules" className="hover:text-[#EA4643] transition-colors">System Core</a></li>
            <li><a href="#roles" className="hover:text-[#EA4643] transition-colors">Role Sync</a></li>
            <li><a href="#integrations" className="hover:text-[#EA4643] transition-colors">Ecosystem</a></li>
            <li><a href={ERP_URL} target="_self" className="hover:text-[#EA4643] transition-colors">Live Portal</a></li>
          </ul>
        </div>
        <div>
          <h5 className="font-black text-slate-950 mb-10 uppercase tracking-[0.4em] text-xs">Connect</h5>
          <ul className="space-y-6 text-slate-500 font-bold text-xl">
            <li><a href="#faq" className="hover:text-[#EA4643] transition-colors">Help Center</a></li>
            <li><a href={PORTFOLIO_URL} target="_blank" className="hover:text-[#EA4643] transition-colors">Founder Office</a></li>
          </ul>
        </div>
      </div>
...
const App: React.FC = () => {
  return (
    <div className="min-h-screen bg-white text-slate-900 antialiased selection:bg-red-100 selection:text-red-900 overflow-x-hidden">
      <Navbar />
      <Hero />
      <StatsStrip />
      <Solutions />
